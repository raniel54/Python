...
# check_numbers = int(input("Digite um numero de 1 a 10\n"))
# r1 = random.randint(1, 10)
# while check_numbers != r1:
#         print(f"Voce errou o numero tente novamente. ")
#         check_numbers = int(input("Digite um numero de 1 a 10\n"))
         
# else:
#     print(f"Parabens voce acertou o numero. Seu numero foi {check_numbers} e o sorteado foi {r1}\n")
